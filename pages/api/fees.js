  ...
  try {
    ...
    const recordsResult = await pool.query(`
      SELECT
        ...
        COALESCE(latest_fp.payment_mode, 'Cash') AS payment_mode,
      ...
      LEFT JOIN LATERAL (
        SELECT id, amount_paid, payment_mode, payment_date, receipt_no, utr
      ...
      GROUP BY
        ...
        s.id,
        latest_fp.id,
        latest_fp.amount_paid,
        latest_fp.payment_mode,
        latest_fp.payment_date,
        latest_fp.receipt_no,
        latest_fp.utr
      ORDER BY a.id DESC
    `);
